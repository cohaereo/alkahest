#pragma once
#ifndef __UMBRASIMD_PS3SPU_H
#define __UMBRASIMD_PS3SPU_H
...
#define SIMDAdd32(a,b)              spu_add(a, b)
#define SIMDSub32(a,b)              spu_sub(a, b)
...
{
    int pattern = 0x00010203 + i*0x04040404;
    return (vec_float4)si_shufb((vec_char16)a,(vec_char16)a,(vec_char16)SIMDLoad32(pattern, pattern, pattern, pattern));
}
UMBRA_FORCE_INLINE SIMDRegister32   SIMDReplicate32(const SIMDRegister32& a, int i)
{
    int pattern = 0x00010203 + i*0x04040404;
    return (vec_int4)si_shufb((vec_char16)a,(vec_char16)a,(vec_char16)SIMDLoad32(pattern, pattern, pattern, pattern));
}
UMBRA_FORCE_INLINE SIMDRegister32   SIMDReplicate16(const SIMDRegister32& a, int i)
{
    return (vec_int4)spu_splats(spu_extract((vec_short8)a, i));
}
...
UMBRA_FORCE_INLINE SIMDRegister     SIMDShuffle(const SIMDRegister& a, const SIMDRegister& b)
{
    ...
    return (vec_float4)si_shufb((vec_char16)a,(vec_char16)b,(vec_char16)pattern);
}
template <int x, int y, int z, int w>
UMBRA_FORCE_INLINE SIMDRegister     SIMDShuffle(const SIMDRegister& a)
{
    ...
    return (vec_float4)si_shufb((vec_char16)a,(vec_char16)a,(vec_char16)pattern);
}
template <int x, int y, int z, int w>
UMBRA_FORCE_INLINE SIMDRegister32   SIMDShuffle32(const SIMDRegister32& a, const SIMDRegister32& b)
{
    ...
    return (vec_int4)si_shufb((vec_char16)a,(vec_char16)b,(vec_char16)pattern);
}
...
UMBRA_FORCE_INLINE void             SIMDWriteNegativeMask(int& result, const SIMDRegister& a)
{
    ...
    vec_uint4 res  = (vec_uint4)si_gb((vector signed char)mask);
