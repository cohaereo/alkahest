...
const WINIT_KEY_COUNT: usize = VirtualKeyCode::Cut as usize + 1;
...
impl InputState {
        ...
        match event {
            Event::WindowEvent { event, .. } => match event {
                ...
                WindowEvent::MouseInput { state, button, .. } => match button {
                    ...
                    winit::event::MouseButton::Other(u) => match u {
                        4 => self.mouse4 = *state == ElementState::Pressed,
                        5 => self.mouse5 = *state == ElementState::Pressed,
                        u => warn!("Unknown mouse button {u}"),
                    },
                },
                _ => {}
            },
    ...
    pub fn key_state(&self, vk: VirtualKeyCode) -> KeyState {
    ...
    pub fn is_key_pressed(&self, vk: VirtualKeyCode) -> bool {
